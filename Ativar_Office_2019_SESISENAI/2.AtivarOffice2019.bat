...
REM Navega para o diretório do Microsoft Office, assumindo que está instalado em "%ProgramFiles%\Microsoft Office\Office16". O parâmetro /d é usado para alterar para o diretório especificado em uma unidade diferente, se necessário.
